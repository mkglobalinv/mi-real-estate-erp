          ...
          <nav className="space-y-1.5 px-3">
            ...
            {(role === 'Social Media Director' || role === 'Customer Care' || role === 'Super Admin') && (
              <>
                ...
                <Link href="/admin/leads" onClick={closeMenu} className={linkClass('/admin/leads')}>
            ...
            {(role === 'Customer Care' || role === 'Super Admin') && (
              <>
                <Link href="/admin/operations/customer-care" onClick={closeMenu} className={linkClass('/admin/operations/customer-care')}>
                  <CheckSquare className={iconClass('/admin/operations/customer-care')} />
                  Support Tickets
                </Link>
                <Link href="/admin/inspections" onClick={closeMenu} className={linkClass('/admin/inspections')}>
            ...
            {(role === 'Social Media Director' || role === 'Super Admin') && (
              <>
                ...
                <Link href="/admin/campaigns" onClick={closeMenu} className={linkClass('/admin/campaigns')}>
                  <Megaphone className={iconClass('/admin/campaigns')} />
                  Campaign Manager
                </Link>
                <Link href="/admin/operations/announcements" onClick={closeMenu} className={linkClass('/admin/operations/announcements')}>
            ...
            {(role === 'Secretary' || role === 'Chairman' || role === 'Super Admin') && (
              <>
                ...
                {(role === 'Secretary' || role === 'Super Admin') && (
                  <Link href="/admin/reservations" onClick={closeMenu} className={linkClass('/admin/reservations')}>
                    <Wallet className={iconClass('/admin/reservations')} />
                    Reservations
                  </Link>
                )}
                <Link href="/admin/operations/payments" onClick={closeMenu} className={linkClass('/admin/operations/payments')}>
                  <Wallet className={iconClass('/admin/operations/payments')} />
                  Payments & Ledger
                </Link>
                {(role === 'Chairman' || role === 'Super Admin') && (
                  <Link href="/admin/operations/approvals" onClick={closeMenu} className={linkClass('/admin/operations/approvals')}>
                    <CheckSquare className={iconClass('/admin/operations/approvals')} />
                    Approvals
                  </Link>
                )}
              </>
            ...
            {(role === 'Director' || role === 'Chairman' || role === 'Super Admin') && (
              <>
                ...
                <Link href="/admin/operations/customers" onClick={closeMenu} className={linkClass('/admin/operations/customers')}>
                  <Users className={iconClass('/admin/operations/customers')} />
            ...
            {(role === 'Admin Engineer' || role === 'Super Admin' || role === 'Director' || role === 'Chairman') && (
              <>
                ...
                <Link href="/admin/projects" onClick={closeMenu} className={linkClass('/admin/projects')}>
                  <FolderGit2 className={iconClass('/admin/projects')} />
                  Estate Projects
                </Link>
                {(role === 'Admin Engineer' || role === 'Super Admin') && (
                  <>
                    <Link href="/admin/listings" onClick={closeMenu} className={linkClass('/admin/listings')}>
                      <MapPin className={iconClass('/admin/listings')} />
                      Website Listings
                    </Link>
                    <Link href="/admin/property-submissions" onClick={closeMenu} className={linkClass('/admin/property-submissions')}>
            ...
            {(role === 'Admin Engineer' || role === 'Super Admin' || role === 'Chairman') && (
              <>
                ...
                <Link href="/admin/logs" onClick={closeMenu} className={linkClass('/admin/logs')}>
                  <Activity className={iconClass('/admin/logs')} />
                  Global Audit Logs
                </Link>
                {(role === 'Admin Engineer' || role === 'Super Admin') && (
                  <>
                    <Link href="/admin/tasks" onClick={closeMenu} className={linkClass('/admin/tasks')}>
