          ...
          <nav className="space-y-1.5 px-3">
            ...
            {(role === 'Social Media Director' || role === 'Customer Care' || role === 'Super Admin') && (
              <>
                ...
                <Link href="/director/leads" onClick={closeMenu} className={linkClass('/admin/leads')}>
            ...
            {(role === 'Customer Care' || role === 'Super Admin') && (
              <>
                <Link href="/director/tickets" onClick={closeMenu} className={linkClass('/admin/tickets')}>
                  <CheckSquare className={iconClass('/admin/tickets')} />
                  Support Tickets
                </Link>
                <Link href="/director/inspections" onClick={closeMenu} className={linkClass('/admin/inspections')}>
            ...
            {(role === 'Social Media Director' || role === 'Super Admin') && (
              <>
                ...
                <Link href="/director/campaigns" onClick={closeMenu} className={linkClass('/admin/campaigns')}>
                  <Megaphone className={iconClass('/admin/campaigns')} />
                  Campaign Manager
                </Link>
                <Link href="/director/announcements" onClick={closeMenu} className={linkClass('/admin/operations/announcements')}>
            ...
            {(role === 'Secretary' || role === 'Chairman' || role === 'Super Admin') && (
              <>
                ...
                {(role === 'Secretary' || role === 'Super Admin') && (
                  <Link href="/director/reservations" onClick={closeMenu} className={linkClass('/admin/reservations')}>
                    <Wallet className={iconClass('/admin/reservations')} />
                    Reservations
                  </Link>
                )}
                <Link href="/director/payments" onClick={closeMenu} className={linkClass('/admin/payments')}>
                  <Wallet className={iconClass('/admin/payments')} />
                  Payments & Ledger
                </Link>
                {(role === 'Chairman' || role === 'Super Admin') && (
                  <Link href="/director/approvals" onClick={closeMenu} className={linkClass('/admin/approvals')}>
            ...
            {(role === 'Director' || role === 'Chairman' || role === 'Super Admin') && (
              <>
                ...
                <Link href="/director/customers" onClick={closeMenu} className={linkClass('/admin/customers')}>
            ...
            {(role === 'Admin Engineer' || role === 'Super Admin' || role === 'Director' || role === 'Chairman') && (
              <>
                ...
                <Link href="/director/projects" onClick={closeMenu} className={linkClass('/admin/projects')}>
                  <FolderGit2 className={iconClass('/admin/projects')} />
                  Estate Projects
                </Link>
                {(role === 'Admin Engineer' || role === 'Super Admin') && (
                  <>
                    <Link href="/director/listings" onClick={closeMenu} className={linkClass('/admin/listings')}>
                      <MapPin className={iconClass('/admin/listings')} />
                      Website Listings
                    </Link>
                    <Link href="/director/property-submissions" onClick={closeMenu} className={linkClass('/admin/property-submissions')}>
            ...
            {(role === 'Admin Engineer' || role === 'Super Admin' || role === 'Chairman') && (
              <>
                ...
                <Link href="/director/logs" onClick={closeMenu} className={linkClass('/admin/logs')}>
                  <Activity className={iconClass('/admin/logs')} />
                  Global Audit Logs
                </Link>
                {(role === 'Admin Engineer' || role === 'Super Admin') && (
                  <>
                    <Link href="/director/tasks" onClick={closeMenu} className={linkClass('/admin/tasks')}>
                      <CheckSquare className={iconClass('/admin/tasks')} />
                      System Tasks
                    </Link>
                    <Link href="/director/settings" onClick={closeMenu} className={linkClass('/admin/settings')}>
