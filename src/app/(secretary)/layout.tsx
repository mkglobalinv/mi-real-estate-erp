          ...
          <nav className="space-y-1.5 px-3">
            ...
            {(role === 'Social Media Director' || role === 'Customer Care' || role === 'Super Admin') && (
              <>
                ...
                <Link href="/secretary/leads" onClick={closeMenu} className={linkClass('/admin/leads')}>
            ...
            {(role === 'Customer Care' || role === 'Super Admin') && (
              <>
                <Link href="/secretary/tickets" onClick={closeMenu} className={linkClass('/admin/tickets')}>
                  <CheckSquare className={iconClass('/admin/tickets')} />
                  Support Tickets
                </Link>
                <Link href="/secretary/inspections" onClick={closeMenu} className={linkClass('/admin/inspections')}>
            ...
            {(role === 'Social Media Director' || role === 'Super Admin') && (
              <>
                ...
                <Link href="/secretary/campaigns" onClick={closeMenu} className={linkClass('/admin/campaigns')}>
                  <Megaphone className={iconClass('/admin/campaigns')} />
                  Campaign Manager
                </Link>
                <Link href="/secretary/announcements" onClick={closeMenu} className={linkClass('/admin/operations/announcements')}>
            ...
            {(role === 'Chairman' || role === 'Super Admin' || role === 'Finance') && (
              <>
                ...
                <Link href="/secretary/payments" onClick={closeMenu} className={linkClass('/admin/payments')}>
                  <Wallet className={iconClass('/admin/payments')} />
                  Payments & Ledger
                </Link>
                {(role === 'Chairman' || role === 'Super Admin') && (
                  <Link href="/secretary/approvals" onClick={closeMenu} className={linkClass('/admin/approvals')}>
            ...
            {(role === 'Admin Engineer' || role === 'Super Admin' || role === 'Director' || role === 'Chairman') && (
              <>
                ...
                <Link href="/secretary/projects" onClick={closeMenu} className={linkClass('/admin/projects')}>
                  <FolderGit2 className={iconClass('/admin/projects')} />
                  Estate Projects
                </Link>
                {(role === 'Admin Engineer' || role === 'Super Admin') && (
                  <>
                    <Link href="/secretary/listings" onClick={closeMenu} className={linkClass('/admin/listings')}>
                      <MapPin className={iconClass('/admin/listings')} />
                      Website Listings
                    </Link>
                    <Link href="/secretary/property-submissions" onClick={closeMenu} className={linkClass('/admin/property-submissions')}>
            ...
            {(role === 'Admin Engineer' || role === 'Super Admin' || role === 'Chairman') && (
              <>
                ...
                <Link href="/secretary/logs" onClick={closeMenu} className={linkClass('/admin/logs')}>
                  <Activity className={iconClass('/admin/logs')} />
                  Global Audit Logs
                </Link>
                {(role === 'Admin Engineer' || role === 'Super Admin') && (
                  <>
                    <Link href="/secretary/tasks" onClick={closeMenu} className={linkClass('/admin/tasks')}>
                      <CheckSquare className={iconClass('/admin/tasks')} />
                      System Tasks
                    </Link>
                    <Link href="/secretary/settings" onClick={closeMenu} className={linkClass('/admin/settings')}>
